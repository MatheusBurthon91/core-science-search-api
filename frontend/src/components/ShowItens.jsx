...
export default function ShowItens({ res, ind }) {
  return (
    <Grid key={res._id} id={ind + res._id} container justifyContent="center" alignItems="center" sx={{ backgroundColor: '#AFB4FF', border: '1px solid white' }}>
      <Grid container justifyContent="center" alignItems="center" sx={{ margin: '15px' }}>
